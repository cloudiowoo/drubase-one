...
namespace Drupal\baas_api\Middleware;
 ...
 */
class ApiAuthenticationMiddleware implements HttpKernelInterface
{
  ...
  public function handle(Request $request, int $type = self::MAIN_REQUEST, bool $catch = true): Response
  {
    ...
    if (!$auth_result['success']) {
      return $this->createAuthenticationError($auth_result);
    }
   ...
   *   错误响应。
   */
  protected function createAuthenticationError(array $auth_result): Response
  {
