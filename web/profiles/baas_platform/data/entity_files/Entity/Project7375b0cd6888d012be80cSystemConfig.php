 ...
 * 表名: baas_856064_system_config
 * 实体类型ID: baas_856064_system_config
 *
 ...
 */
class Project7375b0cd6888d012be80cSystemConfig extends ContentEntityBase {
  ...
  public function __construct(array $values = [], $entity_type_id = NULL, $bundle = NULL, ?array $translations = NULL) {
    parent::__construct($values, 'baas_856064_system_config', NULL, $translations);
