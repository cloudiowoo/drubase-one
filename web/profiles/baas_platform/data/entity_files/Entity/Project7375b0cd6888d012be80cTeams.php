 ...
 * 表名: baas_856064_teams
 * 实体类型ID: baas_856064_teams
 *
 ...
 */
class Project7375b0cd6888d012be80cTeams extends ContentEntityBase {
  ...
  public function __construct(array $values = [], $entity_type_id = NULL, $bundle = NULL, ?array $translations = NULL) {
    parent::__construct($values, 'baas_856064_teams', NULL, $translations);
