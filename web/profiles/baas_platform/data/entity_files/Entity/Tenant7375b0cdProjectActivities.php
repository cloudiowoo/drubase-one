 ...
 *
 * 此文件由BaaS项目系统自动生成。
 * 生成时间: 2025-07-30 13:15:53
 * 表名: baas_00403b_activities
 * 实体类型ID: baas_00403b_activities
 *
 ...
 */
class Tenant7375b0cdProjectActivities extends ContentEntityBase {
  ...
  public function __construct(array $values = [], $entity_type_id = NULL, $bundle = NULL, ?array $translations = NULL) {
    parent::__construct($values, 'baas_00403b_activities', NULL, $translations);
