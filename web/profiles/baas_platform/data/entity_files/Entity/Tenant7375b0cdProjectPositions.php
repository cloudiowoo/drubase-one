 ...
 *
 * 此文件由BaaS项目系统自动生成。
 * 生成时间: 2025-08-05 12:31:01
 * 表名: baas_00403b_positions
 * 实体类型ID: baas_00403b_positions
 *
 ...
 */
class Tenant7375b0cdProjectPositions extends ContentEntityBase {
  ...
  public function __construct(array $values = [], $entity_type_id = NULL, $bundle = NULL, ?array $translations = NULL) {
    parent::__construct($values, 'baas_00403b_positions', NULL, $translations);
