 ...
 *
 * 此文件由BaaS项目系统自动生成。
 * 生成时间: 2025-09-11 17:00:47
 * 表名: baas_00403b_test
 * 实体类型ID: baas_00403b_test
 *
 ...
 */
class Tenant7375b0cdProjectTest extends ContentEntityBase {
  ...
  public function __construct(array $values = [], $entity_type_id = NULL, $bundle = NULL, ?array $translations = NULL) {
    parent::__construct($values, 'baas_00403b_test', NULL, $translations);
